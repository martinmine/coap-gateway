 ...
 * desired coap server.
 */
public class CustomProxyCoapClientResource extends ForwardingResource {

    public CustomProxyCoapClientResource() {
        this("coapClient");
    }

    public CustomProxyCoapClientResource(String name) {
    ...
    public Response forwardRequest(Request request) {
        ...
        try {
            ...
            outgoingRequest = CustomCoapTranslator.getRequest(incomingRequest);
